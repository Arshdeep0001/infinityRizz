...
const HeroSection = () => {
  return (
    <div className="relative h-screen overflow-hidden bg-black">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center bg-black bg-opacity-0">
        ...
        <Link to="/shop" className="bg-transparent text-white border px-6 py-3 hover:bg-white hover:text-black  transition duration-300">Shop Now</Link>
      </div>
    </div>
  );
};
